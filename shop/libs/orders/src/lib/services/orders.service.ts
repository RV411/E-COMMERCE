...
export class OrdersService {
  ...
  createChekoutSession(orderItem:OrderItem[]){
    return this.http.post(`${this.apiURLProducts}/create-checkout-session`, orderItem).pipe(switchMap((session:{id:string})=>{
